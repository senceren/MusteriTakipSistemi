    ...
    public partial class Ilk : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusteriUrun", x => new { x.MusterilerId, x.UrunlerId });
                    table.ForeignKey(
                        name: "FK_MusteriUrun_Musteriler_MusterilerId",
                        column: x => x.MusterilerId,
                        principalTable: "Musteriler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusteriUrun_Urunler_UrunlerId",
